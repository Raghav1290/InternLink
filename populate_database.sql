...
('admin_max', 'Max Admin', 'admin.max@internlink.com', '$2b$12$7OODShuloT0wdTPtrqby9.QaJc6b7lf09wcqLGVExXjNnrnX7Dy5S', 'uploads/default_admin1.png', 'admin', 'active'),
('admin_sara', 'Sara Support', 'sara.bell@internlink.com', '$2b$12$N.MZf8mXg9VxSy7Yd4JBr.LxAMC.9RWGVtZIU2kMwMlm7fO5Vjcsy', 'uploads/default_admin2.png', 'admin', 'active');
...
INSERT INTO `users` (`username`, `full_name`, `email`, `password_hash`, `profile_image`, `role`, `status`) VALUES
('stu_liam', 'Liam Davis', 'liam.d@example.com', '$2b$12$69uFHvRp85pua/C6e21TYe2cSC0csh4VeJG6CFVs51NvvR/FUvjy2', 'uploads/student1.png', 'student', 'active'),
('stu_olivia', 'Olivia White', 'olivia.w@example.com', '$2b$12$oGMxsuqTV.wOBmqmS5t3V.1hPArZBpaegJ3M5PxNe3ep52MiBAFqW', 'uploads/student2.png', 'student', 'active'),
('stu_noah', 'Noah Green', 'noah.g@example.com', '$2b$12$ImQ.rNY1VXISCkd1TKiBTeaXzLvC3OjkUcXQto5TwRweeGM1y6Sai', 'uploads/student3.png', 'student', 'active'),
('stu_emma', 'Emma Black', 'emma.b@example.com', '$2b$12$YWWNaid1juewKNl/VJMzce.eXu82Pi/pazJOIXS/X0ZGz6x6wMk/W', 'uploads/student4.png', 'student', 'active'),
('stu_sophia', 'Sophia Brown', 'sophia.b@example.com', '$2b$12$Pce2gQcyzYubj06cvI7ZpuRvaaA5a.uOUqPj0mazOW8jYIYS0Y65O', 'uploads/student5.png', 'student', 'active'),
('stu_jackson', 'Jackson King', 'jackson.k@example.com', '$2b$12$93e5Xw/CH7rhFQExDdCzt.ZFLvUK38NzbQO60QiDCGZEjIG41xrtC', 'uploads/student6.png', 'student', 'active'),
('stu_ava', 'Ava Queen', 'ava.q@example.com', '$2b$12$yO85J3cmrZiRuqZOQQgAfeSc3RXMYBm/Hw.O10BFODXj8l6yOy.3C', 'uploads/student7.png', 'student', 'active'),
('stu_lucas', 'Lucas Knight', 'lucas.k@example.com', '$2b$12$bd3OwaiUp2IkjbQlxexfTef7lvUGCZg4bAGx6KNET/KvKmDgw02pS', 'uploads/student8.png', 'student', 'active'),
('stu_mia', 'Mia Bishop', 'mia.b@example.com', '$2b$12$dB/4hcwG.THiYcCitJO/PuCXAo3H19ws1MhD2xqmJGLW00HBCwjvW', 'uploads/student9.png', 'student', 'active'),
('stu_aidan', 'Aidan Hunter', 'aidan.h@example.com', '$2b$12$nCGSpP3HEYTjeiUMcCBT4OvKcrPTPMIh01/5Gv97VKrEjBDH8grfa', 'uploads/student10.png', 'student', 'active'),
('stu_isabella', 'Isabella Fisher', 'isabella.f@example.com', '$2b$12$TTOJBbtPoOYA6zEPNe9n5.w528RD98SL0S3OxbSE03Bf3uaMb8p2e', 'uploads/student11.png', 'student', 'active'),
('stu_ethan', 'Ethan Baker', 'ethan.b@example.com', '$2b$12$WWOa6oLKuxiRpEb.K9m6EOx/g1PwKt/sr1OCnNTiKaDhDiUHs3huO', 'uploads/student12.png', 'student', 'active'),
('stu_chloe', 'Chloe Miller', 'chloe.m@example.com', '$2b$12$HEN9UFyv0e2QmsdtvM1W4.ORsIIyusz1dk2JsmL38GMPNMvh7XmX2', 'uploads/student13.png', 'student', 'active'),
('stu_mason', 'Mason Clark', 'mason.c@example.com', '$2b$12$fJXfhtdCmJ5KniBsUxuwXO51Hu/rCkR6B7csq.wirBSt8lBB3JQiW', 'uploads/student14.png', 'student', 'active'),
('stu_harper', 'Harper Lewis', 'harper.l@example.com', '$2b$12$vxHQp5vqXFTKqC/Ujp6C7ugJvlMyyQF51rsg2pmi2nicjPskU/w7q', 'uploads/student15.png', 'student', 'active'),
('stu_logan', 'Logan Hill', 'logan.h@example.com', '$2b$12$VgO8mCIwLOutcuf5sR9vN.kIZR29.J6gu5YFpuz5UJeFbNoXmhfDe', 'uploads/student16.png', 'student', 'active'),
('stu_evelyn', 'Evelyn Scott', 'evelyn.s@example.com', '$2b$12$F8UoQoYvVHnjwwXGLEg.S.E8opfwTF4EJoIdWGE2r.75zhHhKnuHK', 'uploads/student17.png', 'student', 'active'),
('stu_benjamin', 'Benjamin Adams', 'benjamin.a@example.com', '$2b$12$dFe8wg6alt2Y5ATgISQ0/.3r80xScxDlpxz3.Y4yWKgshDh.Kl8qG', 'uploads/student18.png', 'student', 'active'),
('stu_amelia', 'Amelia Ward', 'amelia.w@example.com', '$2b$12$BIoWFValcz1OBtvE8f53J.Svg4zIZlBEBQTCNeQj47E7wgWrSf6xO', 'uploads/student19.png', 'student', 'active'),
('stu_alexander', 'Alexander Bell', 'alexander.b@example.com', '$2b$12$sTKWmL3xYAyWhq4IBN04RuS9JkcbCvaGFZdqlSoCqe5w0Uo7bq50O', 'uploads/student20.png', 'student', 'active');
